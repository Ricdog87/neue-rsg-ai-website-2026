...
const JSON_LD = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
      { "@type": "Question", "name": "Which process eats more than 20 hours of staff time per week — and looks the same every time?", "acceptedAnswer": { "@type": "Answer", "text": "Use this point from the checklist. Red flag: Under 10 h/week · different every time. Green light: > 20 h/week · 80% repetitive logic." } },
      { "@type": "Question", "name": "Is the data the agent needs available digitally somewhere — or does it live in people's heads?", "acceptedAnswer": { "@type": "Answer", "text": "Use this point from the checklist. Red flag: Knowledge sits in 1–2 heads. Green light: Database · wiki · API · CRM." } },
      { "@type": "Question", "name": "What does one week of downtime in this process cost you, concretely in euros?", "acceptedAnswer": { "@type": "Answer", "text": "Use this point from the checklist. Red flag: 'Hard to say'. Green light: Lost revenue × probability · in euros." } },
      { "@type": "Question", "name": "Who makes the final call — and is that person part of the project from day one?", "acceptedAnswer": { "@type": "Answer", "text": "Use this point from the checklist. Red flag: Decision-maker has no time. Green light: CEO/COO is in the sprint 1 h/week." } }
  ],
};
