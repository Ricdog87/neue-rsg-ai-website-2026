...
export function ComparisonSection() {
  const en = useEnglish();
  return (
    <section id="vergleich" className="relative px-6 py-20 md:py-28 lg:px-10">
        ...
        >
          <div className="min-w-[760px]">
            ...
            <div className="grid grid-cols-[1.1fr_1fr_1fr_1.15fr] gap-px">
              ...
              <div className="relative rounded-t-md border-x border-t border-[hsl(var(--accent))]/40 bg-[hsl(var(--accent))]/[0.07] px-5 py-4">
                <span className="absolute -top-2.5 left-5 inline-flex items-center rounded-full bg-[hsl(var(--accent))] px-2.5 py-0.5 font-mono text-[0.55rem] uppercase tracking-[0.18em] text-white shadow-[0_0_20px_hsl(var(--accent)/0.5)]">
                ...
                <div className="mt-0.5 font-mono text-[0.625rem] uppercase tracking-[0.16em] text-[hsl(var(--accent))]/80">{en ? 'automated' : 'automatisiert'}</div>
              </div>
            </div>

            {/* Rows */}
            {ROWS.map((r, i) => (
              <div key={r.c} className="grid grid-cols-[1.1fr_1fr_1fr_1.15fr] gap-px border-t border-[hsl(var(--border))]">
                <div className="flex items-center px-5 py-4 font-mono text-[0.6875rem] uppercase tracking-[0.14em] text-[hsl(var(--subtle))]">
                  {en ? r.cEn : r.c}
                </div>
                ...
                <div className={
                  'flex items-start gap-2 border-x border-[hsl(var(--accent))]/40 bg-[hsl(var(--accent))]/[0.07] px-5 py-4 text-[0.85rem] font-medium leading-snug text-[hsl(var(--fg))]' +
