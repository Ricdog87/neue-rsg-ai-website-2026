          ...
          {testimonials.items.map((item, i) => (
            ...
            >
              <Quote
                ...
                aria-hidden
              />
              <blockquote className="flex-1 font-display text-[1.15rem] font-light leading-[1.45] tracking-tight text-[hsl(var(--fg))] md:text-[1.25rem]">
                „{item.quote}"
              </blockquote>
              <figcaption className="flex items-end justify-between border-t border-[hsl(var(--border))] pt-6">
                <div>
                  <p className="text-[0.875rem] font-medium text-[hsl(var(--fg))]">
                    {item.author}
                  </p>
