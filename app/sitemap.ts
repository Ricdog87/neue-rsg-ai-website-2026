...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPaths: Array<[string, number, 'weekly' | 'monthly' | 'yearly']> = [
    ...
    ['/ki-telefonassistent-mainz', 0.8, 'monthly'],
    ['/ki-telefonassistent-darmstadt', 0.8, 'monthly'],
    ['/ki-telefonassistent-offenbach', 0.8, 'monthly'],
    ...
    ['/ki-telefonassistent-mannheim', 0.8, 'monthly'],
    ['/ki-telefonassistent-heidelberg', 0.8, 'monthly'],
