...
export const metadata: Metadata = {
  ...
  description: 'KI-Telefonassistent für Unternehmen in Darmstadt. Automatisieren Sie Ihre Telefonie mit dem intelligenten Voice-Agenten von RSG AI. Jetzt Demo buchen.',
      ...
      <main className="min-h-screen">
        <section className="py-20 px-6 max-w-5xl mx-auto">
          ...
          <p className="text-xl mb-8 text-gray-600">
            Automatisieren Sie Ihre Telefonie in Darmstadt mit dem intelligenten KI-Telefonassistenten von RSG AI. 24/7 verfügbar, auf Deutsch trainiert, sofort einsatzbereit.
          </p>
