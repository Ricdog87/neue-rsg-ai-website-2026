    ...
    (
      <div
        style={{
          ...
          padding: '76px',
          background:
            'radial-gradient(ellipse 70% 60% at 28% 28%, rgba(20,184,166,0.30) 0%, transparent 60%), radial-gradient(ellipse 60% 50% at 82% 82%, rgba(45,212,191,0.16) 0%, transparent 55%), #03020c',
          color: 'white',
