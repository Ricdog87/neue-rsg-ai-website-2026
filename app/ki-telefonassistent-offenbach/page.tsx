...
export const metadata: Metadata = {
  title: 'KI-Telefonassistent Offenbach | RSG AI – 24/7 Telefon-Automatisierung',
  description: 'KI-Telefonassistent für Unternehmen in Offenbach am Main. Automatisieren Sie Ihre Telefonie mit dem intelligenten Voice-Agent von RSG AI. Jetzt Demo buchen.',
  alternates: { canonical: 'https://www.rsg-ai.de/ki-telefonassistent-offenbach' }
}

export default function KITelefonassistentOffenbach() {
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "RSG AI – KI-Telefonassistent Offenbach",
            "description": "KI-gestützter Telefonassistent für Unternehmen in Offenbach am Main",
            "url": "https://www.rsg-ai.de/ki-telefonassistent-offenbach",
            "areaServed": { "@type": "City", "name": "Offenbach am Main" },
            "address": { "@type": "PostalAddress", "addressLocality": "Offenbach am Main", "addressRegion": "Hessen", "addressCountry": "DE" },
      ...
      <main className="min-h-screen">
        <section className="py-20 px-6 max-w-5xl mx-auto">
          <h1 className="text-4xl font-bold mb-6">KI-Telefonassistent Offenbach</h1>
          <p className="text-xl mb-8 text-gray-600">
            Automatisieren Sie Ihre Telefonie in Offenbach am Main mit dem intelligenten KI-Telefonassistenten von RSG AI.
            24/7 verfügbar, auf Deutsch trainiert, sofort einsatzbereit.
          </p>
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Warum RSG AI in Offenbach?</h2>
              <ul className="space-y-3 text-gray-700">
                <li>✓ Lokaler Support für Offenbacher Unternehmen</li>
