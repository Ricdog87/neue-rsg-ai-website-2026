...
export const metadata: Metadata = {
  ...
  description: 'KI-Telefonassistent für Unternehmen in Mainz. Automatisieren Sie Ihre Telefonie mit dem intelligenten Voice-Agenten von RSG AI. Jetzt Demo buchen.',
