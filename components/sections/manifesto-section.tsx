    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <motion.blockquote
          ...
          className="mt-8 font-display text-balance text-4xl leading-tight tracking-tight md:text-6xl"
        >
        ...
        <motion.div
          ...
          className="mt-12 flex items-center gap-5 rounded-2xl border border-[hsl(var(--accent))/20] bg-[hsl(var(--accent))/5] p-7"
        >
