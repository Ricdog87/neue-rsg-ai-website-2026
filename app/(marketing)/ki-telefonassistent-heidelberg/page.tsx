...
export const metadata: Metadata = {
  ...
  description: 'KI-Telefonassistent für Unternehmen in Heidelberg. Automatisieren Sie Ihre Telefonie mit dem intelligenten Voice-Agenten von RSG AI. Jetzt Demo buchen.',
      ...
      <main className="min-h-screen">
        <section className="py-20 px-6 max-w-5xl mx-auto">
          ...
          <p className="text-xl mb-8 text-gray-600">
            Automatisieren Sie Ihre Telefonie in Heidelberg mit dem intelligenten KI-Telefonassistenten von RSG AI. 24/7 verfügbar, auf Deutsch trainiert, sofort einsatzbereit.
          </p>
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div>
              <h2 className="text-2xl font-semibold mb-4">Warum RSG AI in Heidelberg?</h2>
              <ul className="space-y-3 text-gray-700">
                <li>✓ Lokaler Support für Unternehmen in Heidelberg</li>
                <li>✓ Branchenerfahrung in Baden-Württemberg</li>
