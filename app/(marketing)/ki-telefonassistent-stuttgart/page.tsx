  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <section className="max-w-4xl mx-auto px-6 py-24">
        <div className="text-sm text-white/50 mb-4">Stuttgart · Baden-Württemberg</div>
        ...
        <p className="text-xl text-white/70 mb-8 max-w-2xl">Ihr KI-Telefonassistent in Stuttgart: Nimmt Anrufe entgegen, qualifiziert Leads und bucht Termine – vollautomatisch, DSGVO-konform, 24/7. Kein Headcount nötig.</p>
        ...
        <div className="mt-16"><h2 className="text-2xl font-semibold mb-6">Warum Stuttgarter Unternehmen RSG AI wählen</h2>
